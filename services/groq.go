...
func AskGroq(secretWord string, description string, question string) string {
    ...
    3. เน้นตอบแค่ "ใช่", "ไม่ใช่", "ไม่ใกล้เคียง" หรือ "เกือบละ" แต่ก็ให้เป็นธรรมชาติ ให้ตรงกับความเป็นจริง เช่น มอเตอร์ไซค์ไม่ใช่สิ่งมีชีวิต, แมวไม่ใช่สิ้งของ, โต๊ะไม่ใช่สถานที่, โรงเรียนไม่ใช่ยานพาหนะ อะไรแบบนี้ และการตอบไม่ต้องแข็งทื่อเกินไป และทำตามกฎข้อที่1
