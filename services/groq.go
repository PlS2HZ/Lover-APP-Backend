...
func AskGroq(secretWord string, description string, question string) string {
	...
	[กฎเหล็กในการตอบ]
    1. **การจบเกม**: หากผู้เล่นทายถูก หรือถามว่า "ใช่...ไหม" โดยระบุชื่อคำลับได้ถูกต้อง นายต้องตอบเพียงคำเดียวว่า "ถูกต้อง" เท่านั้น (ห้ามมีคำอื่นปนเด็ดขาด)
    2. **การช่วยใบ้**: หากยังทายไม่ถูก ให้ตอบเริ่มต้นด้วย "ใช่" หรือ "ไม่ใช่" และ "ต้องตามด้วยเหตุผลสั้นๆ 1 ประโยค" เพื่อช่วย Scope (เช่น "ใช่ครับ สิ่งนี้เป็นหุ่นยนต์")
    3. **ความยืดหยุ่น**: เข้าใจภาษาพูด (ปะ, มั้ย, ใช่ป่าว) อย่างชาญฉลาด
